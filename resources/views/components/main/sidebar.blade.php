{{-- resources/views/components/main/sidebar.blade.php --}}
    ...
    <div class="flex items-stretch grow shrink-0 justify-center my-5" id="sidebar_menu">
        <div class="scrollable-y-auto light:[--tw-scrollbar-thumb-color:var(--tw-content-scrollbar-color)] grow"
            ...
            <div class="menu flex flex-col w-full gap-1.5 px-3.5" data-menu="true"
                ...
                {{-- Overview --}}
                <div class="menu-item">
                    <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('dashboard') ? 'menu-item-active:border-gray-200 menu-item-active:bg-light' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                       href="{{ route('dashboard') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('dashboard') ? 'menu-item-active:text-gray-800' : '' }}
                                     dark:menu-item-active:text-gray-900">
                            <i class="ki-filled ki-home-3"></i>
                        </span>
                        <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('dashboard') ? 'menu-item-here:text-gray-900' : '' }}">
                            Overview
                        </span>
                    </a>
                </div>
                ...
                @can('viewAny', \App\Models\Cohort::class)
                    ...
                    <div class="menu-item" data-menu-item-toggle="accordion" data-menu-item-trigger="click">
                        <div class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                                {{ request()->routeIs('cohort.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('cohort.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-users"></i>
                        </span>
                            <span class="menu-title font-medium text-sm text-gray-800
                                     {{ request()->routeIs('cohort.*') ? 'menu-item-here:text-gray-900' : '' }}">
                            Promotions
                        </span>
                            <span class="menu-arrow text-gray-600">
                        ...
                        <div class="menu-accordion gap-px ps-7">
                            ...
                            <div class="menu-item">
                                <a class="menu-link py-2 px-2.5 rounded-md border border-transparent
                                     {{ request()->routeIs('cohort.index') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                                     menu-link-hover:bg-light menu-link-hover:border-gray-200"
                                   href="{{ route('cohort.index') }}">
                                <span class="menu-title text-2sm text-gray-800
                                             {{ request()->routeIs('cohort.index') ? 'menu-item-active:text-gray-900' : '' }}">
                                    Toutes les promotions
                                </span>
                                </a>
                            </div>

                            {{-- Exemple : liste dynamique des promotions > remplacer par @foreach --}}
                            @foreach(\App\Models\Cohort::all() as $c)
                                <div class="menu-item">
                                    <a class="menu-link py-2 px-2.5 rounded-md border border-transparent
                                         {{ request()->routeIs('cohort.show') && request()->route('cohort')->id == $c->id
                                            ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                                         menu-link-hover:bg-light menu-link-hover:border-gray-200"
                                       href="{{ route('cohort.show', $c) }}">
                                    <span class="menu-title text-2sm text-gray-800
                                                 {{ request()->routeIs('cohort.show') && request()->route('cohort')->id == $c->id
                                                    ? 'menu-item-active:text-gray-900' : '' }}">
                                        {{ $c->name }}
                                    </span>
                                    </a>
                                </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('student.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                           href="{{ route('student.index') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('student.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-user-edit"></i>
                        </span>
                            <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('student.*') ? 'menu-item-here:text-gray-900' : '' }}">
                            Étudiants
                        </span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('teacher.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                           href="{{ route('teacher.index') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('teacher.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-security-user"></i>
                        </span>
                            <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('teacher.*') ? 'menu-item-here:text-gray-900' : '' }}">
                            Enseignants
                        </span>
                        </a>
                    </div>
            ...
            <div class="menu flex flex-col w-full gap-1.5 px-3.5" data-menu="true"
                ...
                <div class="menu-item">
                    <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('common-life.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                       href="{{ route('common-life.index') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('common-life.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-abstract-44"></i>
                        </span>
                        <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('common-life.*') ? 'menu-item-here:text-gray-900' : '' }}">
                            Vie commune
                        </span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('group.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                       href="{{ route('group.index') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('group.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-abstract-36"></i>
                        </span>
                        <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('group.*') ? 'menu-item-here:text-gray-900' : '' }}">
                            Groupes
                        </span>
                    </a>
                </div>

                {{-- Bilans de connaissance --}}
                <div class="menu-item">
                    <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('knowledge.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                       href="{{ route('knowledge.index') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('knowledge.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-devices-2"></i>
                        </span>
                        <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('knowledge.*') ? 'menu-item-here:text-gray-900' : '' }}">
                ...
                <div class="menu-item">
                    <a class="menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent
                             {{ request()->routeIs('retro.*') ? 'menu-item-active:bg-light menu-item-active:border-gray-200' : '' }}
                             menu-link-hover:bg-light menu-link-hover:border-gray-200"
                       href="{{ route('retro.index') }}">
                        <span class="menu-icon items-start text-lg text-gray-600
                                     {{ request()->routeIs('retro.*') ? 'menu-item-here:text-gray-800' : '' }}">
                            <i class="ki-filled ki-lovely"></i>
                        </span>
                        <span class="menu-title text-sm text-gray-800 font-medium
                                     {{ request()->routeIs('retro.*') ? 'menu-item-here:text-gray-900' : '' }}">
                            Retrospectives
                        </span>
                    </a>
                </div>
    ...
    <div class="flex flex-center justify-between shrink-0 ps-4 pe-3.5 mb-3.5" id="sidebar_footer">
                ...
                <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
                    <div class="flex items-center justify-between px-5 py-1.5 gap-1.5">
                        ...
                        <span class="badge badge-xs badge-primary badge-outline">
                            {{ optional(auth()->user()->school)->pivot->role ?? '' }}
                        </span>
                    </div>
                        ...
                        <div class="menu-item mb-0.5">
                            <div class="menu-link">
                                ...
                                <label class="switch switch-sm">
                                    <input data-theme-state="dark" data-theme-toggle="true" type="checkbox"/>
                                </label>
                            </div>
                        </div>
        ...
        <div class="flex items-center gap-1.5">
            <div class="dropdown" data-dropdown="true" data-dropdown-offset="10px, 15px"
                ...
                <button class="dropdown-toggle btn btn-icon btn-icon-lg relative size-8
                               hover:bg-light hover:text-primary dropdown-open:bg-gray-200 text-gray-600">
                    <span class="menu-icon"><i class="ki-filled ki-notification-status"></i></span>
                </button>
                <div class="dropdown-content light:border-gray-300 w-full max-w-[460px]">
                    <div class="flex items-center justify-between gap-2.5 text-sm text-gray-900 font-semibold
                                px-5 py-2.5 border-b border-b-gray-200" id="notifications_header">
                        Notifications
                        <button class="btn btn-sm btn-icon btn-light btn-clear shrink-0"
                                data-dropdown-dismiss="true"><i class="ki-filled ki-cross"></i></button>
                    </div>
                    <div class="grow">
                        <div class="flex flex-col">
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-icon btn-icon-lg size-8
                                               hover:bg-light hover:text-primary text-gray-600">
